              ...
              <table bgcolor="#f7f7f7" border="0" cellpadding="0" cellspacing="0" width="100%"> 
                      <tbody><tr> 
                        <td align="left" bgcolor="#efefef" height="22"><table border="0" cellpadding="0" width="100%">
                          <tbody><tr>
                            <td class="crumbs"><img src="../../1px.gif" height="15" width="10"> <a href="http://www.alertfocus.com" class="menu">Home</a>   &gt; <a href="../../relieve/index.php" class="menu">Relieve</a>  &gt; <b class="mse">Addictions</b>  </td>
                          </tr>
                        </tbody></table> </td>
                      </tr> 
                      <tr> 
