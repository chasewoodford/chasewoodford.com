...
<meta http-equiv="description" content=" Attention Deficit Disorder, ADD or ADHD can be relieved with brain training.  Improve the way the brain works and all related symptoms resolve.  Results are sustained because the body recognizes and adopts improved forms of operation.">
              ...
              <table bgcolor="#f7f7f7" border="0" cellpadding="0" cellspacing="0" width="100%"> 
                      <tbody><tr> 
                        <td align="left" bgcolor="#efefef" height="22"><table border="0" cellpadding="0" width="100%">
                          <tbody><tr>
                            <td class="crumbs"><img src="../../1px.gif" height="15" width="10"> <a href="http://www.alertfocus.com" class="menu">Home</a>   &gt; <a href="../../relieve/index.php" class="menu">Relieve</a>  &gt; <b class="mse">ADD</b>  </td>
                          </tr>
                        </tbody></table> </td>
                      </tr> 
                      <tr> 
                      ...
                      <td valign="top" width="100%"> <table class="page" border="0" cellpadding="15" width="100%">
                        <tbody><tr>
                          <td class="page" valign="top"><table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tbody><tr>
                              <td valign="top"><div class="title style1">ADD </div>      </td>
                            </tr>
                          </tbody></table>                          
                            <br>
                            <div class="border smallfont3"> Attention 
Deficit Disorder, ADD or ADHD can be relieved with brain training.  
Improve the way the brain works and all related symptoms resolve.  
Results are sustained because the body recognizes and adopts improved 
forms of operation.</div>
                            <br>
                             <br>                            
            <p>              </p>
