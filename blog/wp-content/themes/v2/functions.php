<?php
    ...
    <li id="comment-<?php comment_ID() ?>" <?php comment_class() ?>>
        <div class="comment-meta"><a href="%3$s" title="Permalink to this comment"><i class="icon-comment" aria-hidden="true"></i></a>&nbsp;<?php commenter_link() ?><?php printf(__(' posted on %1$s', 'your-theme'),
