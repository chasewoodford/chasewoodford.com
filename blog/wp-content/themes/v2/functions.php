<?php
    ...
    <li id="comment-<?php comment_ID() ?>" <?php comment_class() ?>>
        <div class="comment-meta"><?php commenter_link() ?><?php printf(__('Posted %1$s at %2$s <span class="meta-sep">|</span> <a href="%3$s" title="Permalink to this comment"><i class="icon-comment" aria-hidden="true"></i>Permalink</a>', 'your-theme'),
