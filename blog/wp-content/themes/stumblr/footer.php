...
<script>Chirp({
    ...
    templates: {
        tweet: '<div class="quote-before">&#8220;</div><div class="tweet"><p>{{html}}</p></div><div class="quote-after">&#8221;</div><p class="attribute">{{time_ago}}&nbsp;&ndash;&nbsp;via <a href="http://www.twitter.com/chase1263070">Twitter</a><div><a href="https://twitter.com/chase1263070" class="twitter-follow-button" data-show-count="false" data-lang="en">Follow @chase1263070</a></div>'
    }
})</script>
