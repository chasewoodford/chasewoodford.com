        ...
        <div class="grid-8 main-content" role="main">
            ...
            <article class="grid-8">
                ...
                <section>
                    ...
                    <p>
                        This site is powered by <a href="#" target="_blank" title="">Wordpress<sup><i class="icon-popup" aria-hidden="true"></i></sup></a>, hand crafted via <a href="#" target="_blank" title="">Intellij<sup><i class="icon-popup" aria-hidden="true"></i></sup></a>, and hosted by <a href="#" target="_blank" title="">1&1<sup><i class="icon-popup" aria-hidden="true"></i></sup></a>. It features an adaptation of the <a href="#" target="_blank" title="">Starkers<sup><i class="icon-popup" aria-hidden="true"></i></sup></a> theme, as well as the <a href="#" target="_blank" title="">Chirp<sup><i class="icon-popup" aria-hidden="true"></i></sup></a> plugin for displaying tweets, the <a href="#" target="_blank" title="">Amazon Product In a Post<sup><i class="icon-popup" aria-hidden="true"></i></sup></a> plugin for displaying products and the <a href="#" target="_blank" title="">WordPress SEO<sup><i class="icon-popup" aria-hidden="true"></i></sup></a> plugin. Code highlighting is brought to you by <a href="#" target="_blank" title="">Prism<sup><i class="icon-popup" aria-hidden="true"></i></sup></a> Nightly builds of the site are versioned and stored on <a href="#" target="_blank" title="">Github<sup><i class="icon-popup" aria-hidden="true"></i></sup></a>.
                    </p>
                    <p>
