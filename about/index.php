        ...
        <div class="grid-8">
            ...
            <article class="grid-8 hero post type-post">
                <header>
                    <h3 class="title-background post-title">
                        ...
                        <span class="blog-category" style="">
                            <a class="no-shadow" title="view portfolio" href="/work"><i class="icon-picture"></i><span style="margin-left:6px">portfolio</span></a><span style="font-size:12px; padding: 0 10px;">&nbsp;/&nbsp;</span><a class="no-shadow" title="download resume" href="#"><i class="icon-doc"></i><span style="margin-left:4px">resume</span></a>
                        </span>
                    </h3>
                </header>
                <section class="content center">
                    ...
                    <p class="left">
                        <?php query_posts( 'cat=51&posts_per_page=2&orderby=post_date&order=DESC' ); while ( have_posts() ) : the_post();?><?php endwhile; ?>
                    </p>
                    <p class="left lead">
                        { way back when }
                    </p>
