        ...
        <div class="grid-8 main-content" role="main">
            ...
            <article>
                <header>
                    ...
                    <a class="title-bar" href="http://www.calmfocus.com" title="see it live" target="_blank">calmfocus.com</a>
                    </h3>
                </header>
                <section>
                    <div class="grid-8 clearfix image-main text-left">
                        ...
                        <ul class="text-left table">
                            ...
                            <li class="table-row">
                                ...
                                <div class="table-data">calmfocus.com</div>
                            </li>
                            <li class="table-row">
                            ...
                            <li class="table-row">
                                ...
                                <div class="table-data">
                                    <a href="http://www.calmfocus.com" title="see it live" target="_blank"><i class="icon-globe" aria-hidde="true"></i>&nbsp;<span>see it live&raquo;</span></a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <p>
                        <img class="left highlight" src="../../images/highlight-calmFocus-001.png" alt="Old version of calmfocus.com">
                    ...
                    <p>
                        <img class="right highlight" src="../../images/highlight-calmFocus-002.png" alt="USA Today highlight">
                    ...
                    <p>
                        ...
                        <img class="left highlight" src="../../images/highlight-calmFocus-003.png" alt="Color theming highlight">
                    </p>
                    <p class="clearfix">
                    ...
                    <p>
                        <img class="right highlight" src="../../images/highlight-calmFocus-004.png" alt="Most Popular articles highlight">
                    ...
                    <p>
                        ...
                        <img class="left highlight" src="../../images/highlight-calmFocus-005.png" alt="Categories highlight">
                    </p>
                    <p>
                        ...
                        <img class="right highlight" src="../../images/highlight-calmFocus-006.png" alt="Related posts highlight">
                    </p>
                    <p class="clearfix">
                    ...
                    <p>
                        <img class="right highlight" src="../../images/highlight-calmFocus-008.png" alt="Waterfall highlight">
                    ...
                    <p>
                        <img class="left highlight" src="../../images/highlight-calmFocus-007.png" alt="Google Analytics highlight">
