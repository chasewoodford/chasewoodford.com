            ...
            <article>
                ...
                <section>
                    <div class="grid-8 clearfix image-main text-left">
                        <a class="left screenshot" href="https://www.revealmr.com" title="see it live" target="_blank">
                            <img class="main" src="/images/screenshot-revealmr.gif" alt="revealmr.com">
                        </a>
                        <ul class="text-left table">
                            ...
                            <li class="table-row">
                                ...
                                <div class="table-data">
                                    <a href="https://www.revealmr.com" title="see it live" target="_blank"><i class="icon-globe" aria-hidde="true"></i>&nbsp;<span>see it live &raquo;</span></a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <p>
                        Reveal's front-end is built on the <a href="http://getbootstrap.com/2.3.2/" target="_blank">Bootstrap<sup><i aria-hidden="true" class="icon-popup"></i></sup></a> framework. All CSS is written in <a href="http://sass-lang.com/" target="_blank">Sass<sup><i aria-hidden="true" class="icon-popup"></i></sup></a>. The platform also relies heavily on the <a href="http://jquery.com/" target="_blank">jQuery<sup><i aria-hidden="true" class="icon-popup"></i></sup></a> JavaScript library. Behind these three main components, we also use:
                    </p>
                    <ul class="callout-list">
                        ...
                        <li><a href="http://flexpaper.devaldi.com/" target="_blank">FlexPaper<sup><i aria-hidden="true" class="icon-popup"></i></sup></a> for rich and interactive document displays; snd</li>
                        <li><a href="http://www.jwplayer.com/" target="_blank">JW Player<sup><i aria-hidden="true" class="icon-popup"></i></sup></a> for consistent cross-device media displays.</li>
                    </ul>
                    <p>
                    ...
                    <p>
                        Though Bootstrap comes with Glyphicons, we opted to use <a href="http://fortawesome.github.io/Font-Awesome/" target="_blank">Font Awesome<sup><i aria-hidden="true" class="icon-popup"></i></sup></a> as our icon font of choice because the icon set better fit our needs.
                    </p>
                    <p>
                    ...
                    <p>
                        We use <a href="http://www.marketo.com/" target="_blank">Marketo<sup><i aria-hidden="true" class="icon-popup"></i></sup></a> as our primary vehicle for keeping users informed on platform updates. However, we realize not everyone reads these e-mails. Likewise, some features cannot adequately be explained via e-mail. So we've implemented just-in-time education.
                    </p>
                    <p>
