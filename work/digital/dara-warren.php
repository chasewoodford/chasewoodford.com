            ...
            <article>
                ...
                <section>
                    ...
                    <p>
                        ...
                        The client had purchased a domain through GoDaddy. Specifically, GoDaddy's Website Builder Personal, a five-page website deal. She paid about $13 total for the first year of her domain and hosting. With the package you get no access to root files or template code, no FTP access, no database storage and no hosting beyond the images you upload through the WYSIWYG (What You See Is What You Get, or 'wiz-ee-wig') editor. And literally, what you see is what you get, or put another way, you get what you pay for. GoDaddy's website builder was quite a challenge to work with.
                    </p>
                    <p>
                        As a designer, it is difficult to work with for several reasons. You are required to pick from a template before adding content to your site. Each template has unique features. But the problem is, the base template&mdash;the fonts, colors and other styles&mdash;is not directly editable. There is no stylesheet you can edit (probably because most novices wouldn't know how to edit one). Some text sizes, colors and styles are editable using the built-in toolbar, but options for customization are limited. Likewise, the WYSIWYG editor features drag-and-drop modules that allowed for very little customization. For example, the contact form was a contact form; no adding or removing labels or inputs without some serious CSS/JavaScript hacking. Pretty much every change to the template we wanted to make required a ton of extra code to make happen. And because we picked a template we liked the most, but one that we ultimately ended up re-writing top to bottom, the limited functionality of the website builder basically doubled the amount of time it took to design the site.
                    </p>
                    <p>
                        As a developer, the website builder is difficult to work with for several other reasons. Because we wanted to customize the site, we had to build our own CSS file to overwrite all the template styles. However, the styles from our custom stylesheet wouldn't apply to the site until it was published. Meaning, we couldn't adjust our stylesheet and see changes instantly, or even when in preview mode. Each time we made a change to the stylesheet we had to publish and re-load the site outside of GoDaddy's website builder to see the changes in action. Having to do this a hundred times a day really takes the wind out of the sails. Not to mention "hot-coding" is a really poor practice. Likewise, having the site look one way inside the website builder and completely different outside meant developing blindly, in a guess-and-check fashion, which also really slowed things down. The website builder, like most WYSIWYG editors, relies solely on the absolute positioning of everything. Also bad news. This means even the slightest change to content potentially throws off the entire design. This also means you have to place elements in weird places in the WYSIWYG editor because you know that styles from your custom stylesheet will later align the element correctly once applied outside the website builder. One of the other issues I found with GoDaddy's website builder was the automated mobile view, that could either be enabled or disabled, but not customized and only slightly editable. Meaning you have the choice of displaying your page in either a poorly, mistmatching design loosely optimized for mobile devices or as it would display in a desktop browser with no optimization for mobile at all.
                    </p>
                    <p>
                        By now you can probably tell how much I loved working with GoDaddy. I found the website builder horrendously difficult to work with, but imagine it is probably the perfect tool for most of the people who pay $13 annually for their website.
                    </p>
                    <p>

                    </p>
                    <p>
                        I would never recommend GoDaddy as a domain/hosting option for any client. In all honesty, I would turn down most projects that required editing through a WYSIWYG editor, especially a GoDaddy hosted one, but made an exception here for a friend in need. I learned a lot from the experience, but would not put even my worst enemy through the same.
                    </p>
                    <br/>
                    <p class="lead">
