            ...
            <article>
                ...
                <section>
                    ...
                    <p>
                        ...
                        The site features custom web fonts from <a target="_blank" href="http://www.google.com/fonts">Google Fonts<sup><i class="icon-popup" aria-hidden="true"></i></sup></a>: Merriweather and Noticia Text for headers, Open Sans for paragraph text and Strait for small text. The load on the page is relatively small (847 B, ~110ms) and adds a kick of style to some otherwise plain, text-heavy pages. Additionally, because the GoDaddy package we're working with doesn't allow for any file hosting, using Google-hosted web fonts means we don't need to worry about finding a home for our font files or worry about breaking links to them unknowingly in the future. The other nice thing about Google fonts is that as usage of them grows across the Internet, there's a higher chance visitors to our page already have the fonts cached in their system, further reducing the cost of loading the custom fonts. I'm a huge fan of using custom fonts to spice up pages when paired appropriately and used tastefully. It especially made sense to use them in this case, where the writing is really what we want to call attention to.
                    </p>
                    <p>
                        <img class="right highlight" src="../../images/highlight-daraWarren-003.png" alt="Close up of theming elements"/>
                        The look the client wanted for her site, in a word, was "enchanted". Her writing, even though it's aimed for the younger reader, is a bit on the dark side, which is really what makes it interesting and what she wanted to convey with her site. So we kept to a more neutral, Earth-toned color scheme&mdash;text is brown, backgrounds are shades of brown and white, links are shades of green and orange; the colors you might find walking through an enchanted forest in the fall.
                    </p>
                    <p>
